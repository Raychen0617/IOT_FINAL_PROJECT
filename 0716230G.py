...
mac_addr = 'C86208BD2492'  # put here for easy to modify;;  the mac_addr in DAN.py is NOT used
...
DAN.profile['d_name']='0716230_RAY'
...
def doRead( ):
      ...
      while True:
         ...
         if theInput !='quit' and theInput != "exit" and int(theInput)==answer:
